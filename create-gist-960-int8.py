...
if __name__ == "__main__":
    ...
    with h5py.File(output_path, "w") as h5f:
        h5f.create_dataset("train", data=quantized_dataset, compression="gzip")
        h5f.create_dataset("test", data=quantized_queries, compression="gzip")
        h5f.create_dataset("neighbors", data=neighbors, compression="gzip")
        h5f.create_dataset("distances", data=distances, compression="gzip")
