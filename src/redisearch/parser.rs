...
impl RedisConditionParser {
    ...
    pub fn parse(&mut self, meta_conditions: Option<&MetaConditions>) -> Option<FilterCondition> {
    ...
    fn create_condition_subfilters(&mut self, entries: &[ConditionEntry]) -> Vec<FilterCondition> {
